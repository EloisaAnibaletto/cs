...
namespace Views
{
    public class AlterarProcedimento : BaseForm
    {
        FieldForm fieldId;
        ...
        ButtonForm btnConf;
        ButtonForm btnCanc;
        public AlterarProcedimento() : base("Alterar Procedimento", SizeScreen.Small)
        {
            fieldId = new FieldForm("ID de alteração",20,20,150,20);
            fieldDescricao = new FieldForm("Descrição",20,20,150,20);
            fieldPreco = new FieldForm("Preço",20,80,120,20);
