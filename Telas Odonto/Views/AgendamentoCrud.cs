...
namespace Views
{
    public class AgendamentoCrud : BaseForm
    {
        ListView listView;
        ...
        public AgendamentoCrud() : base("Agendamento", SizeScreen.Medium)
        {
            ...
            especialidades.SubItems.Add("01");
            especialidades.SubItems.Add("25/10/2022");
            especialidades.SubItems.Add("01");
            listView.Items.AddRange(new ListViewItem[]{especialidades});
			listView.Columns.Add("ID do paciente", -2, HorizontalAlignment.Left);
    		listView.Columns.Add("ID do dentista", -2, HorizontalAlignment.Left);
            listView.Columns.Add("ID da sala", -2, HorizontalAlignment.Left);
