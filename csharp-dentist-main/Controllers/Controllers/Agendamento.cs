...
namespace Controllers
{
    public class AgendamentoController
    {
        ...
        {   
            Agendamento agendamento = GetAgendamento(Id);
            Models.Agendamento.RemoverAgendamento(agendamento);
            return agendamento;
        }
        ...
        /*public static IEnumerable<Agendamento> GetProcedimentosPorAgendamento(int IdProcedimento) 
        {
            return Agendamento.GetAgendamentos()
