...
namespace ConsultorioOdontologico
{
    public class Program
    {
        ...
        public static void MenuPrincipal()
        {
            ...
            Console.WriteLine("| 7        | Incluir AgendamentoProcedimento    |");
            ...
            Console.WriteLine("| 20       | Excluir AgendamentoProcedimento    |");
            ...
            Console.WriteLine("| 27       | Visualizar AgendamentoProcedimento |");
            Console.WriteLine("+-----------------------------------------------+");
            ...
            do
            {
                ...
                try{
                    switch (opt)
                    {
                        ...
                        case 6:
                        {
                            ProcedimentoView.IncluirProcedimento();
                            break;
                        }
                        case 7:
                        {
                            AgendamentoProcedimentoView.InserirProcedimento();
                            break;
                        }
                        case 8:
                        {
                        ...
                        case 20:
                        {
                            AgendamentoProcedimentoView.ExcluirProcedimento();
                            break;
                        }
                        case 21:
                        {
                        ...
                        case 27:
                        {
                            AgendamentoProcedimentoView.ListarProcedimentos();
                            break;
                        }
                        default:
                        {
